...
namespace margelo::nitro::newpic::visioncamerapose {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NativePosePoint).
   */
  struct NativePosePoint final {
  public:
  ...
  public:
    NativePosePoint() = default;
    explicit NativePosePoint(double x, double y, double z, double confidence): x(x), y(y), z(z), confidence(confidence) {}

  public:
    friend bool operator==(const NativePosePoint& lhs, const NativePosePoint& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ NativePosePoint <> JS NativePosePoint (object)
  template <>
  struct JSIConverter<margelo::nitro::newpic::visioncamerapose::NativePosePoint> final {
    static inline margelo::nitro::newpic::visioncamerapose::NativePosePoint fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::newpic::visioncamerapose::NativePosePoint(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::newpic::visioncamerapose::NativePosePoint& arg) {
